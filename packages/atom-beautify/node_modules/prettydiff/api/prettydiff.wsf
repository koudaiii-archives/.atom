        ...
        <script type="text/javascript" src="../prettydiff-min.js">
            ...
            (function () {
                ...
                var args = {},
                    ...
                    outerror = function (x) {
                        ...
                        if (WScript.Arguments.Count() === 0 || help === true) {
                            ...
                            error.push("");
                            error.push("* methodchain    - boolean - Whether consecutive JavaScript methods should be chained onto a single line of code instead of indented. Default is false.");
                            error.push("");
                ...
                if (fail === false) {
                    ...
                    args.endcomma = (WScript.Arguments.Name("endcomma") === "true" || WScript.Arguments.Name("endcomma") === true);
                    ...
                    args.methodchain = (WScript.Arguments.Named("methodchain") === "true" || WScript.Arguments.Named("methodchain") === true);
                    ...
                    args.tagsort = (WScript.Arguments.Name("tagsort") === "true" || WScript.Arguments.Name("tagsort") === true);
